    ...
    <div id="single-page">
        <div id="page-content" v-if="! isLoading && data">
            ...
            <div class="dashboard-headline">
                <div v-if="config.app_logo_horizontal" class="logo">
                    <a :href="config.host" target="_blank">
                        <img :src="$getImage(config.app_logo_horizontal)" :alt="config.app_name" class="light-mode">
                    </a>
                </div>
                <div class="metadata">
